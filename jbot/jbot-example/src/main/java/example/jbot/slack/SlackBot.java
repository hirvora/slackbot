...
import com.chewy.jbot.core.common.Controller;
import com.chewy.jbot.core.common.EventType;
import com.chewy.jbot.core.common.JBot;
import com.chewy.jbot.core.slack.Bot;
import com.chewy.jbot.core.slack.models.Event;
...
public class SlackBot extends Bot {
    ...
    public void onReceiveDM(WebSocketSession session, Event event) {
    	String commandArgText = event.getText();
    	  String channelId =  event.getChannelId();
    	 // String channelName =  event.getChannel();
    	  String text = "You said " + commandArgText + " at <#" + channelId +">";
    	//  return ctx.ack(text); 
    	  reply(session, event, text);
  		
		if (event.getText().contains("help")) {
			reply(session, event, "1. Option 1 " + "\n" + "2. Option 2 " + "\n" + "3. Option 3" + "\n" + "4. Option 4");
		} else {
			reply(session, event, "I am " + slackService.getCurrentUser().getName());
		}
